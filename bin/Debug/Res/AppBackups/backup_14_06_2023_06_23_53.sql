...
INSERT INTO `category`(`idСategory`,`nameСategory`) VALUES(1,'Антибиотики'),(2,'Иммунная система'),(3,'Противовирусные'),(4,'Противогрибковые'),(20,'Противоопухолевые'),(5,'Сердечно-сосудистые'),(6,'Эндокринология');
...
INSERT INTO `product`(`idProduct`,`nameProduct`,`categoryProduct`,`priceProduct`,`storageRackProduct`,`descriptionProduct`,`manufacturerProduct`,`pictureProduct`,`isPrescriptionProduct`,`discountProduct`) VALUES(1,'Ярина',6,1344.90,6,'','Германия','Ярина.jpg',1,0.11),(2,'Виферон',2,309.50,2,'Действующее вещество: Интерферон альфа-2b. Суппизитории ректальные.','Фероон - Россия','ВИФЕРОН.jpg',0,0.00),(3,'Ингавирин',3,818.00,3,'Действующее вещество: Имидазолилэтанамид пентандиовой кислоты','Валента - Россия','Ингавирин.jpg',0,0.00),(4,'Гриппферон',3,290.18,3,'Действующее вещество: Интерферон альфа-2b','Фирн М. Россия','Гриппферон.jpeg',0,0.00),(5,'Лайфферон',20,769.00,7,'','Россия','Лайфферон.jpg',0,0.00),(6,'Анастрозол',20,1309.00,7,'','Озон, Россия','Анастрозол.jpg',0,0.00),(7,'Зигита',20,2700.08,7,'Таблетки овальные двояковыпуклые от белого до почти белого цвета с гравировкой \"AA250\".','Канада','Зигита.jpg',1,0.00),(8,'Прогестерон',6,705.00,0,'','Дальхимфарм, Россия','Прогестерон.jpg',1,0.00),(9,'Сумамед',1,396.00,1,'','Плива Хрватская д.о.о.','Сумамед.jpg',0,0.00);
...
INSERT INTO `seriesproduct`(`idSeries`,`productIdSeries`,`expirationDateSeries`,`countProductSeries`) VALUES(28,1,'2049-12-28 00:00:00',139),(29,2,'2023-06-30 00:00:00',8),(30,3,'2023-06-14 00:00:00',10),(31,5,'2023-07-02 00:00:00',1),(32,6,'2023-06-01 00:00:00',3),(33,7,'2023-07-07 00:00:00',5),(34,9,'2023-06-24 00:00:00',14);
...
INSERT INTO `list`(`id`,`idOrderList`,`quantityList`,`seriesProductList`,`prescriptionNumberList`) VALUES(39,41,1,29,0),(40,42,1,34,0),(41,42,1,29,0),(42,42,1,28,120);
...
INSERT INTO `order`(`idOrder`,`userOrder`,`dateOrder`) VALUES(41,2,'2023-06-14 00:00:00'),(42,2,'2023-06-14 00:00:00');
...
-- Dump completed on 2023-06-14 06:23:55
-- Total time: 0:0:0:0:942 (d:h:m:s:ms)
