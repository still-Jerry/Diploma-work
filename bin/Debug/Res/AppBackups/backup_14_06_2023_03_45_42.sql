...
INSERT INTO `product`(`idProduct`,`nameProduct`,`categoryProduct`,`priceProduct`,`storageRackProduct`,`descriptionProduct`,`manufacturerProduct`,`pictureProduct`,`isPrescriptionProduct`,`discountProduct`) VALUES(52,'Ярина',6,1344.90,1,'','Германия','Ярина.jpg',1,0.11);
...
INSERT INTO `seriesproduct`(`idSeries`,`productIdSeries`,`expirationDateSeries`,`countProductSeries`) VALUES(28,52,'2049-12-28 00:00:00',140);
...
-- Dump completed on 2023-06-14 03:45:43
-- Total time: 0:0:0:0:727 (d:h:m:s:ms)
