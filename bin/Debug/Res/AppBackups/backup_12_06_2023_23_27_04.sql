...
CREATE TABLE IF NOT EXISTS `new_reserve` (
  ...
  `priceProduct` text,
  `storageRackProduct` text,
  `descriptionProduct` text,
  `manufacturerProduct` text,
  `pictureProduct` text,
  `isPrescriptionProduct` text,
...
INSERT INTO `new_reserve`(`idProduct`,`nameProduct`,`categoryProduct`,`priceProduct`,`storageRackProduct`,`descriptionProduct`,`manufacturerProduct`,`pictureProduct`,`isPrescriptionProduct`,`discountProduct`) VALUES('1','Ингавирин','3','900.00','1','Капсулы. Действующее вещество: Имидазолилэтанамид пентандиовой кислоты','Валента. Россия','638217721723636878Ингавирин.jpg','0','0.15'),('2','Гриппферон','3','290.00','1','Капли назальные. Действующее вещество: Интерферон альфа-2b',' Фирн М. Россия','Гриппферон.jpeg','0','0.15');
...
INSERT INTO `seriesproduct`(`idSeries`,`productIdSeries`,`expirationDateSeries`,`countProductSeries`) VALUES(1,3,'2023-05-31 00:00:00',5),(2,2,'2023-06-24 00:00:00',95),(3,23,'2023-12-30 00:00:00',66),(4,21,'2023-05-29 00:00:00',30),(5,1,'2023-05-29 00:00:00',40),(6,3,'2025-05-23 00:00:00',110),(7,4,'2023-06-04 00:00:00',6),(8,6,'2023-06-03 00:00:00',4),(9,6,'2023-07-30 00:00:00',15),(10,8,'2026-08-15 00:00:00',140),(11,10,'2023-12-30 00:00:00',10),(12,11,'2023-05-29 00:00:00',50),(13,12,'2023-09-10 00:00:00',90),(14,20,'2045-11-17 00:00:00',7996),(16,2,'2023-05-29 00:00:00',89),(20,29,'2025-07-18 00:00:00',65),(21,1,'2023-05-28 00:00:00',23),(23,2,'2023-06-02 00:00:00',0),(24,1,'2023-05-31 00:00:00',230),(27,21,'2023-07-09 00:00:00',100);
...
INSERT INTO `list`(`id`,`idOrderList`,`quantityList`,`seriesProductList`,`prescriptionNumberList`) VALUES(16,18,1,3,0),(17,18,2,2,0),(18,19,5,20,3450),(19,19,1,23,0),(20,20,1,14,0),(21,21,2,14,0),(22,22,1,2,0),(31,33,1,2,0),(32,34,1,3,0),(33,35,1,3,0),(34,36,1,3,0),(35,37,1,3,0),(36,38,1,3,0),(37,39,1,3,0),(38,40,1,3,0);
...
-- Dump completed on 2023-06-12 23:27:05
-- Total time: 0:0:0:0:756 (d:h:m:s:ms)
